...
CREATE TABLE tes_paper (
  ...
  common_score DOUBLE(7,2) not NULL DEFAULT '0.00' COMMENT '常规试题的最终得分',
  receipt_score DOUBLE(7,2) not NULL DEFAULT '0.00' COMMENT '翻打凭条的最终得分',
  receipt_rate DOUBLE(7,2) not NULL DEFAULT '0.00' COMMENT '翻打凭条的正确率',
...
CREATE TABLE tes_answer (
  ...
  is_del INT(1) not NULL DEFAULT '-1' COMMENT '删除标志',
  user_id BIGINT(21) not NULL DEFAULT '-1' COMMENT '作答人',
...
CREATE TABLE tes_scene (
  ...
  receipt_score int(11) not null default 0 comment '凭条分值',
